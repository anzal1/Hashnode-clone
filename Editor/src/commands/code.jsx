...
export const code = {
  ...
  execute: (tate, api) => {
    ...
    if (state1.selectedText.indexOf("\n") === -1) {
      ...
      const selectionEnd = selectionStart + state1.selectedText.length + 2;
    ...
    const selectionEnd = selectionStart + state1.selectedText.length + 8;
...
//! This code is not needed because upper `code` has same functionality.
